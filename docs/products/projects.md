...
The frontend consumes the following endpoints. Full backend contract details live in [projects_router](../core/shared_api_routers.md).
...
- [shared_api_routers](../core/shared_api_routers.md) — Backend `projects_router` API details.
