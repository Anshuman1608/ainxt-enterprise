...
- **Authentication**: All routes depend on `auth.dependencies.get_current_user` (see [auth_router](../auth/auth_router.md) and [auth dependencies](../core/shared_core.md)).
- **Job queue**: `build_graph` uses `core.job_queue.enqueue_job` with `Q_KB` to schedule asynchronous work (see [core infrastructure](../core/shared_core.md)).
...
- **Frontend**: The web UI consumes these endpoints through `KnowledgeGraph.jsx`, `KbScopeGraph.jsx`, and `KbDrillGraph.jsx` (see ai_ui_frontend knowledge_graph and kb_graph).
...
- [auth dependencies](../core/shared_core.md) - user authentication and JWT context.
- [core logger](../core/shared_core.md) - structured logging.
- [core job queue](../core/shared_core.md) - asynchronous job enqueueing.
- [db database](../core/shared_core.md) - SQLAlchemy session management.
- [workers knowledge_graph_worker](../workers/workers.md) - graph construction and clustering.
- [workers index_worker](../workers/workers.md) - code-node mirroring during repo indexing.
- [workers kb_entity_worker](../workers/workers.md) - document entity extraction.
- [store kb_entity_registry](../core/shared_core.md) - canonical entity resolution.
- ai_ui_frontend KnowledgeGraph - interactive graph visualization.
- ai_ui_frontend KbScopeGraph / KbDrillGraph - scope picker visualizations.
