...
**Dependencies:**
- [core.model_registry](../core/shared_core.md) for canonical model constants.
...
**Dependencies:**
- [models.hybrid_retriever](../core/shared_core.md)
...
|-----------------|--------|-------|
| LLM model registry | [core.model_registry](../core/shared_core.md) | Canonical model IDs and display labels. |
...
| Hybrid retriever | [models.hybrid_retriever](../core/shared_core.md) | Codebase semantic search. |
| PostgreSQL | db.database | Security scan storage. |
| Auth / RBAC | [auth.rbac](../auth/authentication.md), [auth.jwt_handler](../auth/authentication.md) | Admin checks and claim resolution. |
| Telemetry | [core.telemetry](../core/shared_core.md) | Usage and latency metrics. |
...
- [shared_core model_routing](../core/shared_core.md) — Model registry and hybrid retriever.
- database — PostgreSQL schema and session management.
