...
| `db.database.SessionLocal` | database.md | SQLAlchemy session factory |
| `db.models.GeneratedDocument` | database.md | Generated document audit rows |
| `db.models.GeneratedImage` | database.md | Generated image audit rows |
| `db.models.ChatAttachment` | database.md | Uploaded chat file rows |
| `db.models.Thread`, `ThreadMessage` | database.md | Thread/message rows |
...
- database.md — PostgreSQL models consumed by purge workers.
