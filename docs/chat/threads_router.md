...
|------------|--------|----------------|
| `store.threads_store` | shared_core → store_layer | store_layer |
| `store.inbox_store` | shared_core → store_layer | store_layer |
| `store.sdlc_store` | shared_core → store_layer | store_layer |
...
| `models.model_router` | shared_core → model_routing | [model_routing](../llm/model_routing.md) |
| `models.hybrid_retriever` | shared_core → model_routing | [model_routing](../llm/model_routing.md) |
| `core.security_validation` | shared_core → core_infrastructure | [core_infrastructure](../core/core_infrastructure.md) |
| `core.kafka_producer` | shared_core → core_infrastructure | [core_infrastructure](../core/core_infrastructure.md) |
| `core.job_queue` | shared_core → core_infrastructure | [core_infrastructure](../core/core_infrastructure.md) |
| `core.kv` | shared_core → kv_store | kv_store |
| `auth.dependencies` / `auth.rbac` | shared_core → authentication | [authentication](../auth/authentication.md) |
| `tools.jira_tools` | shared_integrations | [shared_integrations](../skills/shared_integrations.md) |
| `tools.gitlab_tools` | shared_integrations | [shared_integrations](../skills/shared_integrations.md) |
| `db.database` / `db.models` | shared_core → database | database |
| Kafka consumer (`_handle_thread_events`) | workers → kafka_event_consumer | [kafka_event_consumer](../workers/kafka_event_consumer.md) |
| SDLC workers | workers → sdlc_pipeline_workers | [sdlc_pipeline_workers](../sdlc/sdlc_pipeline_workers.md) |
