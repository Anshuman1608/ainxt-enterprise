...
The chat module integrates with three layers of memory, documented in detail in memory_system.
...
- **[agent_management](../agents/agent_management.md)** — Agent catalog chat (`agent_id` scoping), `AgentRunner`
- **[model_and_tool_listing](../llm/model_and_tool_listing.md)** — Model listing, tool catalog
- **[openai_compatible_endpoints](../llm/openai_compatible_endpoints.md)** — Anthropic Messages API compatibility
- **[audit_and_tracing](../security/audit_and_tracing.md)** — Request tracing, audit logging
- **[security_and_governance](../security/security_and_governance.md)** — Compliance engine, rate limiting, guardrails
- **memory_system** — RedisMemory, PostgresMemory, chat_summarizer, structured_facts
- **database** — Chat, ChatMessage, ChatAttachment models
- **[core_infrastructure](../core/core_infrastructure.md)** — KV store, telemetry, circuit breaker, distributed semaphore
- **[llm_proxy_main](../llm/llm_proxy_main.md)** — LLM proxy service for vision and text generation
- **[chat_agent_execution_workers](../workers/chat_agent_execution_workers.md)** — `chat_worker.py`, `kafka_consumer.py`
- **[kafka_event_consumer](../workers/kafka_event_consumer.md)** — `_handle_chat_history` consumer
