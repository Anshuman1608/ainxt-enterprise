...
- [sdlc_pipeline_workers](sdlc_pipeline_workers.md) — RQ worker jobs that execute the pipeline
...
- [authentication](../auth/authentication.md) — Auth dependencies and RBAC
- [core_infrastructure](../core/core_infrastructure.md) — Job queue, config, logger
- store_layer — sdlc_store, sdlc_artifacts, governance stores
