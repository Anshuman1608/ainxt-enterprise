...
- **REST API calls** from the [sdlc_router](../core/shared_api_routers.md) (manual triggers, approvals, resumes)
- **GitLab MR webhooks** (PR review pipeline)

It delegates to the [shared_core_sdlc_pipeline](../sdlc/shared_core_sdlc_pipeline.md) sub-modules for the state machine, CLI engine, governance engine, and patch engine, and persists all state through the store_layer.
...
The SDLC pipeline is exposed through the [sdlc_router](../core/shared_api_routers.md) with endpoints including:
...
The [sdlc_pipeline](../sdlc/sdlc_pipeline.md) frontend component (`ai-ui/src/components/SDLCPipeline.jsx`) provides a real-time dashboard with:
...
| Module | Relationship |
|--------|-------------|
| [shared_core_sdlc_pipeline](../sdlc/shared_core_sdlc_pipeline.md) | Contains the state machine, CLI engine, governance engine, patch engine, and pipeline orchestration |
| store_layer | Persistence: `sdlc_store`, `sdlc_artifacts`, `sdlc_governance_findings`, `sdlc_governance_approvers`, `inbox_store` |
| [shared_api_routers](../core/shared_api_routers.md) | REST API surface (`sdlc_router.py`) |
| [sdlc_pipeline_workers](sdlc_pipeline_workers.md) | RQ worker entry points |
| [core_infrastructure](../core/core_infrastructure.md) | Logger, telemetry, config, circuit breaker, security validation |
| [agent_system](../agents/agent_system.md) | Parent module containing this sub-module |
| [sdlc_pipeline](../sdlc/sdlc_pipeline.md) | Frontend UI component |
...
- [shared_core_sdlc_pipeline](../sdlc/shared_core_sdlc_pipeline.md) — Detailed documentation of the state machine, CLI engine, and governance sub-modules
- [sdlc_pipeline_workers](sdlc_pipeline_workers.md) — RQ worker job definitions
- [shared_api_routers](../core/shared_api_routers.md) — REST API router documentation
- store_layer — Persistence layer documentation
- [sdlc_pipeline](../sdlc/sdlc_pipeline.md) — Frontend UI component documentation
- [core_infrastructure](../core/core_infrastructure.md) — Logging, telemetry, and configuration
- [agent_system](../agents/agent_system.md) — Parent agent framework documentation
