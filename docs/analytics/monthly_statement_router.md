...
`monthly_statement_service` module.
...
| `db.database.SessionLocal` | database | SQLAlchemy session factory |
| `db.models.User` | database | User ORM model |
| `db.monthly_statement_models` | database | Statement & preference ORM models |
