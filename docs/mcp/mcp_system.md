...
| **Bridge & External Registry** | `mcp/bridge.py`, `mcp/external_registry.py` | Unified router between internal MCP servers, external MCP servers, and the legacy registry. | |
| **Clients** | `mcp/client/sse_client.py`, `mcp/client/stdio_client.py` | Async MCP client transports over SSE and stdio. | |
