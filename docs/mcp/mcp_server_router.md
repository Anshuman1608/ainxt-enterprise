...
- **Database**: External server removal updates the `mcp_external_servers` table directly to mark the server as disabled.
...
- Database — SQLAlchemy session management and `mcp_external_servers` persistence.
