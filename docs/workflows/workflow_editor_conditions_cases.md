...
| `operator` | `string` | One of the supported operators from [`constants/operators.js`](../core/constants.md). |
...
| Module | Relationship |
|--------|--------------|
| [`app_models`](../core/app_models.md) | Defines `ConditionNode`, `ConditionCase`, and `SingleCondition` Pydantic models that mirror the frontend shape. |
| [`engine_native_engine`](../agents/engine_native_engine.md) | Evaluates the condition cases at workflow runtime. |
| [`services_services`](../workers/services_services.md) | Provides graph utilities such as `get_linear_order` used when validating condition routing. |
...
| [`constants/operators.js`](../core/constants.md) | Defines field presets, operator lists, type coercion helpers, and the plain-English preview builder. |
...
- Backend models: [`app_models`](../core/app_models.md)
- Runtime engine: [`engine_native_engine`](../agents/engine_native_engine.md)
- Shared operators/constants: [`constants`](../core/constants.md)
- Workflow persistence: `workflowStore`
