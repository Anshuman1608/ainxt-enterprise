...
// gitlab and github are both listed unconditionally — a deployment connects
// whichever one its SCM_PROVIDER uses and simply ignores the other card.
const ENABLED_CONNECTORS = new Set(["microsoft_365", "gitlab", "github", "jira_connector", "gmail"]);
