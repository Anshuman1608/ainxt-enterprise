        ...
        "tools": [
            {
                ...
                # connectors/probe.py::select_probe picks it for the connection
                # test (every other github_* tool requires a repo_id, which made
                # `GET /connectors/github/test` fail "Required parameter missing").
                "name": "github_list_my_repos",
                "description": "List repositories the authenticated user can access (most recently updated first). Use this to discover repo names ('owner/repo') for the other github_* tools when the user hasn't named one.",
                "method": "GET",
                "path": "/user/repos",
                "requires_scopes": [],
                "cache_ttl_s": 120,
                ...
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "limit": {"type": "integer", "description": "Max repos to return (1–100, default 20)."},
                    },
                    "required": [],
                },
            },
